...
cmd=sprintf("/share/apps/genomics/plink-2.0/bin/plink2 --bfile %s --keep %s --pheno %s --maf 0.05 --covar %s --covar-variance-standardize --glm hide-covar --out %s.results.%d",
		PlinkRoot,
		PlinkPhenoFile,
		PlinkPhenoFile,
		PCsFile,
...
# for chr in {1..22}; do subComm.sh /share/apps/R-3.6.1/bin/Rscript ~/UKBB/UKBBscripts.20220912/runGWAS.20241014.R UKBB.depression.WB.20240209.txt $chr; done
