...
# dx cd / ; dx run swiss-army-knife -y --instance-type mem3_hdd2_v2_x4  -imount_inputs=FALSE -iin="/scripts/runGeneSet.20230804.sh" -icmd="bash runGeneSet.20230804.sh $model $chr /geneLists/$geneList "
