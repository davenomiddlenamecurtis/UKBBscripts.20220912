...
BestGenesFile="asthma.20240610.bestGenes.txt"
TestsFile="/home/rejudcu/pars/UKBB.annot.allTests.20231126.txt"
TopTestsFile="asthma.topTests.20240610.txt"
NewModel="UKBB.asthma.best.annot.20240610"
NewArgFile=sprintf("/home/zhenzliu/scripts/rsco.%s.rarg",NewModel)

ScoreAssocCommand="/home/zhenzliu/scripts/subComm.sh /share/apps/R-3.6.1/bin/Rscript /home/rejudcu/scoreassoc/scoreassoc.R"


wd="/home/zhenzliu/asthma"
setwd(wd)
