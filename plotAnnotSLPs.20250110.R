...
ewNames=c("MINUSGPN","AlphaMissenseCategory","AlphaMissenseScore",extraWeights[,1])
...
firstResult[10:11,1]=c("AlphaMissense_Category","AlphaMissense_Score")
...
means=sprintf("%.2f",rowMeans(allResults[,2:ncol(allResults)]))
