...
geneModelsFn="/home/rejudcu/UKBB/annot.2025/geneModels.20231109.txt"
varCatsFn="/home/rejudcu/UKBB/annot.2025/varCats.20210401.txt"
catsFn="/home/rejudcu/UKBB/annot.2025/categories.txt"
extraWeightsFn="/home/rejudcu/UKBB/annot.2025/extraWeights.20210413.txt"
...
ewNames=c("AM_prediction","AM_score","MINUSGPN",extraWeights[,1])
...
colnames(coeffs)=c("Weight",cnames)
coeffs[,2:5]=mat_coef[23:nrow(mat_coef),]
coeffs[,1]=rownames(mat_coef)[23:nrow(mat_coef)]
coeffs
# I think maybe this is all nonsense because the predictors are highly correlated with each other?
