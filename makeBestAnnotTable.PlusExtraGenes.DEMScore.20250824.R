...
ResultsFile="DEMScore.PlusExtraGenes.Results.txt"
GenesToAdd=c("SLC22A4")
...
ExtraGenes=GenesToAdd[! (GenesToAdd %in% Top[,1])]
...
ExtraGenes=GenesToAdd[! (GenesToAdd %in% GenesToDo[,1])]
